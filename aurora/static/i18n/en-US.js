langs.enUS = {
  ...
  '无状态和无连接减少流量模式特征提高设备电源效率。': 'Stateless and connectionless reduce traffic patterns to improve device power efficiency.',
  '我们理解互联网自由的原理，并在我们的代码中付诸实践。': 'We understand the principles of internet freedom and put them into practice in our code.',
  '为满足特定用户群体，根据需求以提供满足特定需求的服务。': 'To meet the needs of specific user groups, provide services that meet specific needs according to demand.',
  '历经5年研发，为大中华地区用户保护私隐，逾越网路封锁。': 'After 5 years of research and development, protect the privacy of users in Greater China and overcome network blocking.',
  '从入口到落地精选优质运营商，多层线路优化，负载均衡设定。': 'From entrance to landing, carefully selected high-quality operators, multi-level line optimization, and load balancing settings.',
  '公式：(实际上行 + 实际下行) x 扣费倍率 = 扣除流量': 'Formula: (Actual uplink + actual downlink) x deduction multiple = deducted traffic',
  '我们也照顾来自世界其他地方的客户，接受 PayPal 付款。': 'We also take care of customers from other parts of the world and accept PayPal payments.',
  '什么是 ShadowSocks 和 ShadowSocksR？': 'What are ShadowSocks and ShadowSocksR?',
  '我们所有套餐都有固定的流量限制。但是，所有套餐都是不限速使用。': 'All our packages have fixed data limits. However, all packages are unlimited speed.',
  '高价购入IPLC内网专线，精心优化传输算法，只为您上网更爽快。': 'Purchase IPLC intranet dedicated lines at high prices, carefully optimize transmission algorithms, just to make your internet experience more enjoyable.',
  ...
  '总部位于美国，经过专业训练的计算机科学家和网络工程师组成的团队。': 'Headquartered in the United States, a team of professionally trained computer scientists and network engineers.',
  '即使通过公共WiFi上网，高强度数据加密也能保护你的私隐不被监视。': 'Even when accessing the Internet through public WiFi, high-strength data encryption can protect your privacy from being monitored.',
  '最先进流量隐藏技术，将VPN穿墙流量化身网页浏览，免于防火墙干扰。': 'The most advanced traffic hiding technology disguises VPN wall-piercing traffic as web browsing to avoid firewall interference.',
  '私密浏览？浏览器无痕模式不够。我们的VPN为您隐藏IP以掩藏踪迹。': 'Private browsing? Incognito mode in browsers is not enough. Our VPN hides your IP to cover your tracks.',
  '记，也不记。我们会在短时间内记录您的流量元数据，并定期对删除老数据。': 'Remember or not. We will record your traffic metadata for a short time and regularly delete old data.',
  '我们努力改善您的互联网体验，让您自由重来：免受审查，监控和电讯商限速。': 'We strive to improve your internet experience and set you free again: free from censorship, monitoring and telecom throttling.',
  '从 8 个国家地区的 38 组服务器集群中任意选择。您可到达网路上任何地方。': 'Choose freely from 38 server clusters in 8 countries and regions. You can go anywhere on the network.',
  '对于来自中国的客户，我们的支付宝接口将支付流程简化为二维码扫描。轻松一秒过。': 'For customers from China, our Alipay interface simplifies the payment process to QR code scanning. Easy one second pass.',
  '提供Telegram、邮件、工单7x24小时客服支持，帮助客户解决疑难问题。': 'Provide Telegram, email, and work order 7x24 hour customer support to help customers solve difficult problems.',
  '支持Android、iOS、MacOS、Windows、Linux、路由器。': 'Support Android, iOS, MacOS, Windows, Linux, routers.',
  '我们以极高的价格购买市面上最好线路。所以, 别再为他人的米其林餐厅账单付费啦。': "We buy the best routes on the market at very high prices. So don't pay for someone else's Michelin restaurant bill anymore.",
  '可选 ChaCha20、Salsa20、AES、IDEA 和 RC4 等高级加密方式。': 'Optional ChaCha20, Salsa20, AES, IDEA and RC4 and other advanced encryption methods.',
  '我们多个级别套餐分别有 50GB、200GB和 高达5TB等，满足您不同场景需求使用。': 'We have multiple level packages of 50GB, 200GB and up to 5TB, etc. to meet your needs in different scenarios.',
  '对于那些注重私隐的朋友，我们没忽略您的需求：我们接受数十种加密货币，您可以放心匿名付款。': 'For friends who value privacy, we have not ignored your needs: we accept dozens of encrypted currencies, you can rest assured to pay anonymously.',
  '节点全解锁Netflix、Tiktok等流媒体服务。你可从任何地方欣赏异国限定媒体节目。': 'The nodes fully unlock Netflix, Tiktok and other streaming media services. You can enjoy foreign exclusive media programs from anywhere.',
  '只为您自己的用量买单，别再补贴BT爱好者啦。如果您更喜欢精致美食，为什么要去自助餐厅吃到饱？': "Only pay for your own usage, don't subsidize BT enthusiasts anymore. If you prefer delicate food, why go to a buffet restaurant to eat as much as you want?",
  'ShadowSocksR 是前者的主要分支，修补了安全漏洞，扩展了加密选项，增加了流量混淆能力。': 'ShadowSocksR is the main branch of the former, patched security vulnerabilities, expanded encryption options, and increased traffic obfuscation capabilities.',
  ...
  '我们相信我们的定价结构是公平和合理的。一些所谓不限流量的商家会使用一些垃圾线路，导致您的上网体验很差。': 'We believe our pricing structure is fair and reasonable. Some so-called unlimited traffic merchants will use some garbage lines, resulting in a very poor internet experience.',
  ...
  'ShadowSocks 是一种无连接无状态的代理协议。它承载 TCP UDP 数据，可轻松穿透世界上最强国家防火墙，中国的 GFW 。': "ShadowSocks is a connectionless and stateless proxy protocol. It carries TCP UDP data and can easily penetrate the world's strongest national firewall, China's GFW.",
  ...
  '于X到期，距离到期还有X天，已用流量将在X日后重置': 'Expires on {expiredDate}, {expiredResidue} days left until expiration, used traffic will be reset {resetDay} days later',
  ...
  '我们接受世界各地发行的主要信用卡。包括 Visa、 MasterCard、 American Express、 Discover、 Diners Club、 JCB 和中国银联。': 'We accept major credit cards issued around the world, including Visa, MasterCard, American Express, Discover, Diners Club, JCB and China UnionPay.',
