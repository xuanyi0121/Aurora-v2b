langs.zhCN = {
  ...
  '记，也不记。我们会在短时间内记录您的流量元数据，并定期对删除老数据。': '记，也不记。我们会在短时间内记录您的流量元数据，并定期对删除老数据。',
  '我们努力改善您的互联网体验，让您自由重来：免受审查，监控和电讯商限速。': '我们努力改善您的互联网体验，让您自由重来：免受审查，监控和电讯商限速。',
  '从 8 个国家地区的 38 组服务器集群中任意选择。您可到达网路上任何地方。': '从 8 个国家地区的 38 组服务器集群中任意选择。您可到达网路上任何地方。',
  '对于来自中国的客户，我们的支付宝接口将支付流程简化为二维码扫描。轻松一秒过。': '对于来自中国的客户，我们的支付宝接口将支付流程简化为二维码扫描。轻松一秒过。',
  ...
  '我们以极高的价格购买市面上最好线路。所以, 别再为他人的米其林餐厅账单付费啦。': '我们以极高的价格购买市面上最好线路。所以, 别再为他人的米其林餐厅账单付费啦。',
  '可选 ChaCha20、Salsa20、AES、IDEA 和 RC4 等高级加密方式。': '可选 ChaCha20、Salsa20、AES、IDEA 和 RC4 等高级加密方式。',
  '我们多个级别套餐分别有 50GB、200GB和 高达5TB等，满足您不同场景需求使用。': '我们多个级别套餐分别有 50GB、200GB和 高达5TB等，满足您不同场景需求使用。',
  '对于那些注重私隐的朋友，我们没忽略您的需求：我们接受数十种加密货币，您可以放心匿名付款。': '对于那些注重私隐的朋友，我们没忽略您的需求：我们接受数十种加密货币，您可以放心匿名付款。',
  '节点全解锁Netflix、Tiktok等流媒体服务。你可从任何地方欣赏异国限定媒体节目。': '节点全解锁Netflix、Tiktok等流媒体服务。你可从任何地方欣赏异国限定媒体节目。',
  '只为您自己的用量买单，别再补贴BT爱好者啦。如果您更喜欢精致美食，为什么要去自助餐厅吃到饱？': '只为您自己的用量买单，别再补贴BT爱好者啦。如果您更喜欢精致美食，为什么要去自助餐厅吃到饱？',
  'ShadowSocksR 是前者的主要分支，修补了安全漏洞，扩展了加密选项，增加了流量混淆能力。': 'ShadowSocksR 是前者的主要分支，修补了安全漏洞，扩展了加密选项，增加了流量混淆能力。',
  '如果您的订阅地址或信息发生泄露可以执行此操作。重置后您的 UUID 及订阅将会变更，需要重新导入订阅。': '如果您的订阅地址或信息发生泄露可以执行此操作。重置后您的 UUID 及订阅将会变更，需要重新导入订阅。',
  '我们相信我们的定价结构是公平和合理的。一些所谓不限流量的商家会使用一些垃圾线路，导致您的上网体验很差。': '我们相信我们的定价结构是公平和合理的。一些所谓不限流量的商家会使用一些垃圾线路，导致您的上网体验很差。',
  '如阻止每一个连接，随之而来的附带质押损害及其昂贵，也就促使审查机构放行看似合规的网路流量。这样，才有了我们的质押自由。': '如阻止每一个连接，随之而来的附带质押损害及其昂贵，也就促使审查机构放行看似合规的网路流量。这样，才有了我们的质押自由。',
  '在防火墙检查时，混淆后的 VPN 流量看似普通网上冲浪或电影串流。因此，审查者无法确定哪些流量需要阻止，哪些流量可以放行。': '在防火墙检查时，混淆后的 VPN 流量看似普通网上冲浪或电影串流。因此，审查者无法确定哪些流量需要阻止，哪些流量可以放行。',
  'ShadowSocks 是一种无连接无状态的代理协议。它承载 TCP UDP 数据，可轻松穿透世界上最强国家防火墙，中国的 GFW 。': 'ShadowSocks 是一种无连接无状态的代理协议。它承载 TCP UDP数据，可轻松穿透世界上最强国家防火墙，中国的 GFW 。',
  '我们自研的私有协议，可以模拟多种网页浏览场景。使得防火墙无法可靠区分 VPN 数据浏览。如强行阻拦亦会影响正常使用网络，因此连接无法有效拦截。': '我们自研的私有协议，可以模拟多种网页浏览场景。使得防火墙无法可靠区分 VPN 数据浏览。如强行阻拦亦会影响正常使用网络，因此连接无法有效拦截。',
  'VPN 提供了一系列好处：通过加密，通讯数据变得难以破解；藉由隧道，线上活动的细节内容被掩藏；借助转发，网路流量看似来自无关的 IP 地址和地理位置。': 'VPN 提供了一系列好处：通过加密，通讯数据变得难以破解；藉由隧道，线上活动的细节内容被掩藏；借助转发，网路流量看似来自无关的 IP 地址和地理位置。',
  '于X到期，距离到期还有X天，已用流量将在X日后重置': '于 {expiredDate} 到期，距离到期还有 {expiredResidue} 天，已用流量将在{resetDay}日后重置',
  '市面上几乎所有的电子设备，我们都能支持。鉴于我们支援多种开源和自研的 VPN 协议，我们相信您可以在几乎任何市售设备上轻松连接到我们的 VPN 网络。': '市面上几乎所有的电子设备，我们都能支持。鉴于我们支援多种开源和自研的 VPN 协议，我们相信您可以在几乎任何市售设备上轻松连接到我们的 VPN 网络。',
  'VPN 是虚拟专用网络（Virtual Private Network）的缩写。它通过在公共网络上建立专用隧道并加密其中传输的数据来保护两个或多个设备之间的通信。': 'VPN 是虚拟专用网络（Virtual Private Network）的缩写。它通过在公共网络上建立专用隧道并加密其中传输的数据来保护两个或多个设备之间的通信。',
  'ShadowSocks（简称 SS，又称影梭）是一种加密的无状态代理协议。它在传输层工作，中继 TCP 和 UDP 流量。它可以轻松穿透最强大的国家级防火墙（中国的 GFW ）。':
    'ShadowSocks（简称 SS，又称影梭）是一种加密的无状态代理协议。它在传输层工作，中继 TCP 和 UDP 流量。它可以轻松穿透最强大的国家级防火墙（中国的 GFW ）。',
  '我们接受世界各地发行的主要信用卡。包括 Visa、 MasterCard、 American Express、 Discover、 Diners Club、 JCB 和中国银联。': '我们接受世界各地发行的主要信用卡。包括 Visa、 MasterCard、 American Express、 Discover、 Diners Club、 JCB 和中国银联。',
