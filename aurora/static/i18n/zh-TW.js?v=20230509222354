langs.zhTW = {
  ...
  '记，也不记。我们会在短时间内记录您的流量元数据，并定期对删除老数据。': '記,也不記。我們會在短時間內記錄您的流量元數據,並定期對刪除老數據。',
  '我们努力改善您的互联网体验，让您自由重来：免受审查，监控和电讯商限速。': '我們努力改善您的互聯網體驗,讓您自由重來:免受審查,監控和電訊商限速。',
  '从 8 个国家地区的 38 组服务器集群中任意选择。您可到达网路上任何地方。': '從 8 個國家地區的 38 組服務器集群中任意選擇。您可到達網路上任何地方。',
  '对于来自中国的客户，我们的支付宝接口将支付流程简化为二维码扫描。轻松一秒过。': '對於來自中國的客戶,我們的支付寶接口將支付流程簡化為二維碼掃描。輕鬆一秒過。',
  ...
  '我们以极高的价格购买市面上最好线路。所以, 别再为他人的米其林餐厅账单付费啦。': '我們以極高的價格購買市面上最好線路。所以, 別再為他人的米其林餐廳帳單付費啦。',
  '可选 ChaCha20、Salsa20、AES、IDEA 和 RC4 等高级加密方式。': '可選 ChaCha20、Salsa20、AES、IDEA 和 RC4 等高級加密方式。',
  '我们多个级别套餐分别有 50GB、200GB和 高达5TB等，满足您不同场景需求使用。': '我們多個級別套餐分別有 50GB、200GB和 高達5TB等,滿足您不同場景需求使用。',
  '对于那些注重私隐的朋友，我们没忽略您的需求：我们接受数十种加密货币，您可以放心匿名付款。': '對於那些注重私隱的朋友,我們沒忽略您的需求:我們接受數十種加密貨幣,您可以放心匿名付款。',
  '节点全解锁Netflix、Tiktok等流媒体服务。你可从任何地方欣赏异国限定媒体节目。': '節點全解鎖Netflix、Tiktok等流媒體服務。你可從任何地方欣賞異國限定媒體節目。',
  '只为您自己的用量买单，别再补贴BT爱好者啦。如果您更喜欢精致美食，为什么要去自助餐厅吃到饱？': '只為您自己的用量買單,別再補貼BT愛好者啦。如果您更喜歡精緻美食,為什麼要去自助餐廳吃到飽?',
  'ShadowSocksR 是前者的主要分支，修补了安全漏洞，扩展了加密选项，增加了流量混淆能力。': 'ShadowSocksR 是前者的主要分支,修補了安全漏洞,擴展了加密選項,增加了流量混淆能力。',
  '如果您的订阅地址或信息发生泄露可以执行此操作。重置后您的 UUID 及订阅将会变更,需要重新导入订阅。': '如果您的訂閱地址或信息發生泄露可以執行此操作。重置後您的 UUID 及訂閱將會變更,需要重新導入訂閱。',
  '我们相信我们的定价结构是公平和合理的。一些所谓不限流量的商家会使用一些垃圾线路，导致您的上网体验很差。': '我們相信我們的定價結構是公平和合理的。一些所謂不限流量的商家會使用一些垃圾線路,導致您的上網體驗很差。',
  '如阻止每一个连接，随之而来的附带质押损害及其昂贵，也就促使审查机构放行看似合规的网路流量。这样，才有了我们的质押自由。': '如阻止每一個連接,隨之而來的附帶質押損害及其昂貴,也就促使審查機構放行看似合規的網路流量。這樣,才有了我們的質押自由。',
  '在防火墙检查时，混淆后的 VPN 流量看似普通网上冲浪或电影串流。因此，审查者无法确定哪些流量需要阻止，哪些流量可以放行。': '在防火牆檢查時,混淆後的 VPN 流量看似普通網上衝浪或電影串流。因此,審查者無法確定哪些流量需要阻止,哪些流量可以放行。',
  'ShadowSocks 是一种无连接无状态的代理协议。它承载 TCP UDP 数据，可轻松穿透世界上最强国家防火墙，中国的 GFW 。': 'ShadowSocks 是一種無連接無狀態的代理協議。它承載 TCP UDP數據,可輕鬆穿透世界上最強國家防火牆,中國的 GFW 。',
  '我们自研的私有协议，可以模拟多种网页浏览场景。使得防火墙无法可靠区分 VPN 数据浏览。如强行阻拦亦会影响正常使用网络，因此连接无法有效拦截。': '我們自研的私有協議,可以模擬多種網頁瀏覽場景。使得防火牆無法可靠區分 VPN 數據瀏覽。如強行阻攔亦會影響正常使用網絡,因此連接無法有效攔截。',
  'VPN 提供了一系列好处：通过加密，通讯数据变得难以破解；藉由隧道，线上活动的细节内容被掩藏；借助转发，网路流量看似来自无关的 IP 地址和地理位置。': 'VPN 提供了一系列好處:通過加密,通訊數據變得難以破解;藉由隧道,線上活動的細節內容被掩藏;借助轉發,網路流量看似來自無關的 IP 地址和地理位置。',
  '于X到期，距离到期还有X天，已用流量将在X日后重置': '於 {expiredDate} 到期，距離到期還有 {expiredResidue} 天，已用流量將在{resetDay}日後重設',
  '市面上几乎所有的电子设备，我们都能支持。鉴于我们支援多种开源和自研的 VPN 协议，我们相信您可以在几乎任何市售设备上轻松连接到我们的 VPN 网络。': '市面上幾乎所有的電子設備,我們都能支持。鑒於我們支援多種開源和自研的 VPN 協議,我們相信您可以在幾乎任何市售設備上輕鬆連接到我們的 VPN 網絡。',
  'VPN 是虚拟专用网络（Virtual Private Network）的缩写。它通过在公共网络上建立专用隧道并加密其中传输的数据来保护两个或多个设备之间的通信。': 'VPN 是虛擬專用網絡(Virtual Private Network)的縮寫。它通過在公共網絡上建立專用隧道並加密其中傳輸的數據來保護兩個或多個設備之間的通信。',
  ...
  '我们接受世界各地发行的主要信用卡。包括 Visa、 MasterCard、 American Express、 Discover、 Diners Club、 JCB 和中国银联。': '我們接受世界各地發行的主要信用卡。包括 Visa、 MasterCard、 American Express、 Discover、 Diners Club、 JCB 和中國銀聯。',
  'ShadowSocksR（简称 SSR）是 SS 的主要分支。在 SS 的基础上，SSR 修补了安全漏洞，扩展了密码套件选项，增加了流量混淆，并提高了运营商级别的 QoS 优先级。': 'ShadowSocksR(簡稱 SSR)是 SS 的主要分支。在 SS 的基礎上,SSR 修補了安全漏洞,擴展了密碼套件選項,增加了流量混淆,並提高了運營商級別的 QoS 優先級。',
